...
const Aisle = ({
  ...
  console.log(isEditMode, "is edit");
  return (
    <group position={currentPosition} rotation={[0, currentRotation, 0]}>
              ...
              <ControlButton
                ...
                onClick={() => {
                  ...
                  onRackUpdate({
                    position: newPosition,
                    aisleDegree:
                      ((currentRotation * 180) / Math.PI) % 360 || 360,
                  });
                }}
              />
              {/* Down Button */}
      ...
      <group position={[(currentRacks.length * rackSpacing) / 2, 4.3, 0]}>
        <Box args={[1.5, 0.8, 0.1]} position={[0, 0, -0.05]}>
        ...
        {currentRacks.map((rack, index) => (
          <group key={rack.id}>
            <DoubleRack
              ...
              highlightedProduct={
                highlightedProduct && highlightedProduct.rackId === rack.id
                  ? highlightedProduct
                  : null
              }
            />
